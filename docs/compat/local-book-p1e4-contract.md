...
状态：**审查完成；E4-TXT-1、E4-TXT-2、E4-EPUB-1、E4-EPUB-2、E4-UMD-1 与 E4-CBZ-1 已完成实现与回归。其余真实格式和完整旧挂载卷项目仍待继续。**
...
| E4-EPUB-2 | **已完成（Docker 发布验证待执行）**：NAV/NCX fragment、同 XHTML 多目录项 slice、跨 XHTML 链接、相对图片/样式/字体、旧 metadata 惰性恢复与 capability 绑定。详见 [`epub-fragment-p1e4-contract.md`](epub-fragment-p1e4-contract.md)。 | parser、import、资源 capability、iframe real browser、migration/security |
...
- E4-TXT-1、E4-TXT-2、EPUB 首封面、E4-EPUB-2、E4-UMD-1 与 E4-CBZ-1 已完成；下一步处理 E4-PDFMD-1 与 E4-VOLUME-1；每项仍遵守“合同、失败测试、实现”顺序。
