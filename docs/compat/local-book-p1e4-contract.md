...
状态：**审查完成；E4-TXT-1、E4-TXT-2 与 E4-EPUB-1 的“纯图片首封面资源”子项已实现并完成后端、前端和三视口真实浏览器验证。其余真实格式、EPUB fragment/跨资源和旧挂载卷项目仍待继续。**
...
- 下一步为 E4-TXT-1 的真实编码/无目录端到端夹具，之后依次处理 E4-UMD-1、E4-CBZ-1、E4-PDFMD-1 与 E4-VOLUME-1；每项仍遵守“合同、失败测试、实现”顺序。
