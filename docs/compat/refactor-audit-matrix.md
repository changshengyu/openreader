...
|---|---|---|---|---|
| Index 工作台、搜索、探索、侧边栏 | `web/src/views/Index.vue` | `layouts/AppLayout.vue`、`views/Home.vue`、`Search.vue`、`Discover.vue`、`stores/indexWorkspace.js` | **P1-A 已发布；P1-B 契约已提取**：根场景/旧链接收敛、三态结果与 260/270 手势具备技术栈等价基础；搜索默认 60、候选档位、旧设置读取和无书源错误为 **must-fix**，全局操作仍待逐个复审。 | `docs/compat/index-workspace-p1-contract.md`、`docs/compat/index-search-p1b-contract.md` → P1-B 测试 → 390/360/1440 浏览器流。 |
