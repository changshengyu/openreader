...
| 测试、构建、Docker、卷升级 | 上游功能契约；OpenReader Docker/data 约束 | `frontend/tests`、`scripts/smoke`、`backend/**/*_test.go`、Dockerfile、release scripts | **当前 BookGroup 第二轮与夜间文字节点内容面修复已由本机作为 `5459f02` 发布**：frontend 663/663、Go、build、BookGroup 真实五视口 manager、三视口 BookManage/BookInfo set、mock 五视口、新卷 portable v1/v2 assets/跨用户/重启和历史 TXT/EPUB/UMD/CBZ/相对缓存/owner isolation 均通过。 | `5459f02`/`latest` 共同指向 amd64/arm64 OCI index `sha256:a8d04ee3e5f6aac3e2a41b908da175e17b7a57e1fb440df51677f35d9496afe9`；等待设备验收。 |
