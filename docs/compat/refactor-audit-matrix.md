...
|---|---|---|---|---|
| Index 工作台、搜索、探索、侧边栏 | `web/src/views/Index.vue` | `layouts/AppLayout.vue`、`views/Home.vue`、`Search.vue`、`Discover.vue`、`stores/indexWorkspace.js` | **工作台主流程已完成，但设置/操作面第二轮复审为 implementation-pending**：根场景、搜索/探索、260/270 手势、共享 BookInfo、认证会话和 owner-v1 缓存已有专项证据；新审查发现后端状态误绑书架刷新、全局刷新语义缩窄、重复书架/RSS/替换规则入口和 Home 操作顺序偏差。原作者公众号/TG 明确不复制，JWT 管理员与可移植备份保留为允许适配。 | 既有证据见 [`index-workspace-p1-contract.md`](index-workspace-p1-contract.md)、[`index-search-p1b-contract.md`](index-search-p1b-contract.md)、[`index-authenticated-session-p1-contract.md`](index-authenticated-session-p1-contract.md)、[`index-local-cache-scope-p1-contract.md`](index-local-cache-scope-p1-contract.md)；待实施差异见 [`index-settings-action-surface-second-audit-p1-contract.md`](index-settings-action-surface-second-audit-p1-contract.md)。 |
| 书架、BookManage、BookGroup、BookInfo | `BookShelf.vue`、`BookManage.vue`、`BookGroup.vue`、`BookInfo.vue`、`main.js#getCover`、`BookController#getBookCover` | `Home.vue`、`OverlayBookManagement.vue`、`OverlayBookGroups.vue`、`BookInfoDialog.vue`/`BookInfoPanel.vue`、`BookCover.vue`、`RemoteBookResultGroups.vue`、`stores/bookshelf.js`、`useSync.js` | **BookManage 第二轮已发布 `af4e2a4`；BookGroup 第二轮已发布 `5459f02`；BookInfo 第二轮已发布 `7f7e2ef`**。BookInfo 恢复 500px/手机 fullscreen、唯一上游骨架、自然比例封面、完整 kind/逐行简介、所有书架书追更和 URL 权威身份；搜索/探索结果卡先选分组，BookInfo 直接加入。 | [`bookinfo-fixed-baseline-second-audit-p2-contract.md`](bookinfo-fixed-baseline-second-audit-p2-contract.md) 已通过 frontend 668/668、Go、build、工作台/临时 Reader 三视口、真实 Go/SQLite 五视口和新旧卷；当前状态 `aligned / Docker-published`，OCI index `sha256:c1017da51c0e121e75add217be6979a2b6bba9bfd9c676590dd892644cf4702c`。 |
...
| 测试、构建、Docker、卷升级 | 上游功能契约；OpenReader Docker/data 约束 | `frontend/tests`、`scripts/smoke`、`backend/**/*_test.go`、Dockerfile、release scripts | **当前 ReaderSettings 第二轮固定基准切片已由本机作为 `40f124f` 发布**：frontend 680/680、Go、build、五个自适应视口及强制手机 iPad、新卷 portable v1/v2 assets/跨用户/重启和历史 TXT/EPUB/UMD/CBZ/相对缓存/owner isolation 均通过。 | `40f124f`/`latest` 共同指向 amd64/arm64 OCI index `sha256:d9395b19f45bfe9412facbcdcec63e776c881c13437c6049e70140f3f87e6b45`；等待设备验收。 |
