...
| 测试、构建、Docker、卷升级 | 上游功能契约；OpenReader Docker/data 约束 | `frontend/tests`、`scripts/smoke`、`backend/**/*_test.go`、Dockerfile、release workflow | `5b79ad3` 本地通过 frontend 754/754、Go focused/race/full/vet、build、Compose；桌面 Reader 多视口和章节 Gin 并发合同通过。可信 Actions run `34816091195` 又通过 backend/frontend/build/Compose、native、fresh/portable、historical volume 与 published-platform 门。 | Git HEAD、Actions 和 Docker commit 均为 `5b79ad3`；已发布 `5b79ad3`/`latest` OCI index `sha256:558d4476ab2857905f194f18157da9a8b195477ad7733e08160ddf45af4a2e69`。amd64 manifest `sha256:4b4864634b595afa13df18562c692ec3712c050e5453b29c29189a941fa42f81`，arm64 manifest `sha256:e8dd34ad3a0302516742f10a2ede082ac892a88f35eb05122931971529ac218a`；`unknown/unknown` 为 attestation，用户生产环境运行提交未知。 |
