...
| 测试、构建、Docker、卷升级 | 上游功能契约；OpenReader Docker/data 约束 | `frontend/tests`、`scripts/smoke`、`backend/**/*_test.go`、Dockerfile、release scripts | **当前 `0db752e` 已从本机完成并发布**：frontend 639/639、Go、build、书源 ownership 专项、新卷、旧全局源历史卷、logical/portable、管理员/普通用户根、跨用户、COW、恢复与重启均通过；`0db752e`/`latest` 共同指向 `sha256:83f53fe3aa523fc1196454d4c5f1d413648eb72ad1e87c83c838e7200859207e`。 | `openreader-regression`、`openreader-docker-release`；继续保留 Reader 真实手机体感验收，不能用本批数据门替代设备结论。 |
