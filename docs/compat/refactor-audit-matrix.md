...
| 书架、BookManage、BookGroup、BookInfo | `BookShelf.vue`、`BookManage.vue`、`BookGroup.vue`、`BookInfo.vue` | `Home.vue`、`OverlayBookManagement.vue`、`OverlayBookGroups.vue`、`BookInfoDialog.vue`/`BookInfoPanel.vue` | **BookGroup P2 已完成；书架最新章节时间 P1 已随 `a10ad14` 发布**：卡片现只显示独立 `lastCheckTime`，新增章节/换源、阅读进度、插入时间和元数据编辑的语义已分离；旧库加法回填和 reader-dev 备份往返有合同。前端 512/512、Go/build、三视口专项 Chromium、新旧卷/便携备份通过。 | [`book-group-p2-contract.md`](book-group-p2-contract.md)、[`bookshelf-last-check-time-p1-contract.md`](bookshelf-last-check-time-p1-contract.md)；等待用户在真实书架确认历史书籍的显示时间与排序。 |
...
| 测试、构建、Docker、卷升级 | 上游功能契约；OpenReader Docker/data 约束 | `frontend/tests`、`scripts/smoke`、`backend/**/*_test.go`、Dockerfile、release scripts | **当前发布 `a10ad14` 已验证**：前端 512/512、Go 全量、生产构建、书架时间三视口专项 Chromium，以及普通和历史 TXT/EPUB/UMD/CBZ/相对缓存 volume/backup 均通过；镜像在本机完成双架构构建并上传。上一批 Reader/WebDAV 门禁继续由 `544e1fb` 继承。 | `openreader-regression`、`openreader-docker-release`；当前 index `sha256:76c9851fb5a10d44722fff35986cd78d7aa43176faf8b1658d4d3f134a740a0d`，amd64 `sha256:01377a52853ede692f50c940b53dc586e44886d704eeaed76f7fd9500b3123cb`，arm64 `sha256:b78c0689d8483e51177c79c2f9e262aa5ab08c92f9432d86454c5fbdea59e2da`。 |
