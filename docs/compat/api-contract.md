...
| Uploads | `/api/uploads` | Uploaded assets must be content-validated, rooted under data uploads and user-scoped for new writes/deletes; legacy global upload URLs remain readable. BookInfo ownership is in [`bookinfo-shelf-mutations-p2-contract.md`](bookinfo-shelf-mutations-p2-contract.md); Reader upload/save/delete ordering and pending content-signature hardening are in [`reader-appearance-assets-p2-contract.md`](reader-appearance-assets-p2-contract.md). |
