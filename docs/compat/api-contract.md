...
### P2 local-book archive filesystem lifecycle (2026-08-24 extracted)
...
wrote generation/metadata outside `LibraryDir`, and removed the outside book directory after batch delete. Status is
**inventory-complete / implementation-pending**; red tests and implementation must follow as separate commits.
