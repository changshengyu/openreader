...
- 本批通过 `go test ./...`、`npm test`（386）、`npm run build`、`PUSH=0` 本地镜像构建，以及
  `cff8c11` 的普通与 `HISTORICAL_VOLUME=1` 全格式 Docker smoke。已从本机发布
  `ghcr.io/changshengyu/openreader:cff8c11` 与 `:latest`；两者同为 OCI index
  `sha256:97b7d2b6aa99fbb95f1c7df5556657abb75df7883e19e2a312698c2fbecc21b0`
  （amd64 `sha256:809700f6069709b41ed5cbb166ab0db5a84a9aaf642992f6618a0dcab204bf92`；arm64
  `sha256:0af535a0ec700657014d06a73ead6e36eb0495058f11019e1d0a4ce43e82be0e`）。
